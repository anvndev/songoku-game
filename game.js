    ...
    switch(String.fromCharCode(event.keyCode))
    {
        ...
        case 'Z'://pouvoir
            ...
            if(boolp && can_p)
            {
                ...
                if(x >= xj)
                {
                    document.getElementById('pouvoir'+p).innerHTML = "@keyframes pouvoir"+p+"\n  {\n   0%{bottom:"+parseInt(y+85)+"px;left:"+(x >= 60 ?parseInt(x-60):'0')+"px;opacity:1;}\n   90%{opacity:1;}\n   100%{bottom:"+parseInt(y+85)+"px;left:"+((y+73) <= (yj+130) && (y+140) >= y? (touchedj = true, xj+10) : "0")+"px;opacity:0;}\n  }";
                    document.getElementById('p'+p).style = 'animation: pouvoir'+p+' '+((y+73) <= (yj+130) && (y+140) >= y? "0.5" : parseFloat((x/10+120)/120))+'s;';
                }
                else
                {
                    document.getElementById('pouvoir'+p).innerHTML = "@keyframes pouvoir"+p+"\n  {\n   0%{bottom:"+parseInt(y+85)+"px;left:"+(x <= 810 ?parseInt(x+120):'932')+"px;opacity:1;}\n   90%{opacity:1;}\n   100%{bottom:"+parseInt(y+85)+"px;left:"+((y+73) <= (yj+130) && (y+140) >= y? (touchedj = true, xj+60) : "932")+"px;opacity:0;}\n  }";
                    document.getElementById('p'+p).style = 'animation: pouvoir'+p+' '+((y+73) <= (yj+130) && (y+140) >= y? "0.5" : parseFloat(120/(x/10+120)))+'s;';
                }
